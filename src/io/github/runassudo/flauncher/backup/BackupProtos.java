...
package io.github.runassudo.flauncher.backup;
...
public interface BackupProtos {
  ...
  public static final class Key extends
    ...
    public Key clear() {
      type = io.github.runassudo.flauncher.backup.BackupProtos.Key.FAVORITE;
      name = "";
      id = 0L;
      checksum = 0L;
      cachedSize = -1;
      ...
      while (true) {
        ...
        switch (tag) {
          ...
          case 8: {
            ...
            switch (value) {
              case io.github.runassudo.flauncher.backup.BackupProtos.Key.FAVORITE:
              case io.github.runassudo.flauncher.backup.BackupProtos.Key.SCREEN:
              case io.github.runassudo.flauncher.backup.BackupProtos.Key.ICON:
              case io.github.runassudo.flauncher.backup.BackupProtos.Key.WIDGET:
                this.type = value;
                break;
            }
            break;
  ...
  public static final class Journal extends
    ...
    public io.github.runassudo.flauncher.backup.BackupProtos.Key[] key;

    // optional int32 backup_version = 6 [default = 1];
    public int backupVersion;

    // optional .launcher_backup.DeviceProfieData profile = 7;
    public io.github.runassudo.flauncher.backup.BackupProtos.DeviceProfieData profile;
    ...
    public Journal clear() {
      ...
      bytes = 0L;
      rows = 0;
      key = io.github.runassudo.flauncher.backup.BackupProtos.Key.emptyArray();
      backupVersion = 1;
      profile = null;
      cachedSize = -1;
      return this;
    ...
    public void writeTo(com.google.protobuf.nano.CodedOutputByteBufferNano output)
      ...
      if (this.key != null && this.key.length > 0) {
        for (int i = 0; i < this.key.length; i++) {
          io.github.runassudo.flauncher.backup.BackupProtos.Key element = this.key[i];
          if (element != null) {
      ...
      while (true) {
        ...
        switch (tag) {
          ...
          case 42: {
            ...
            io.github.runassudo.flauncher.backup.BackupProtos.Key[] newArray =
                new io.github.runassudo.flauncher.backup.BackupProtos.Key[i + arrayLength];
            if (i != 0) {
              java.lang.System.arraycopy(this.key, 0, newArray, 0, i);
            }
            for (; i < newArray.length - 1; i++) {
              newArray[i] = new io.github.runassudo.flauncher.backup.BackupProtos.Key();
          ...
          case 58: {
            if (this.profile == null) {
              this.profile = new io.github.runassudo.flauncher.backup.BackupProtos.DeviceProfieData();
            }
  ...
  public static final class Widget extends
    ...
    public io.github.runassudo.flauncher.backup.BackupProtos.Resource icon;
    ...
    public Widget mergeFrom(
      ...
      while (true) {
        ...
        switch (tag) {
          ...
          case 34: {
            if (this.icon == null) {
              this.icon = new io.github.runassudo.flauncher.backup.BackupProtos.Resource();
            }
